import { getAllSubDistricts } from "@/services/address-service";
...
export default function SubDistrict() {
  ...
  return (
    <>
      ...
      <div className="mx-auto text-center text-3xl mt-8 mb-6 font-semibold">Desa/Kelurahan</div>
